<!-- registry-sync: version=11.7.0; skills=1474; stars=38716; updated_at=2026-05-26T06:05:42+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,474+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,474+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,474+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,474+ Skills](#browse-1474-skills)
...
If you want a faster answer than "browse all 1,474+ skills", start with a tool-specific guide:
